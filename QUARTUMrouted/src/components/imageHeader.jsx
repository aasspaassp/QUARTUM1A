...
export default function ImageHeader() {
  ...
  return (
      ...
      <div className="flex px-6 pt-10 lg:px-7">
        <div
          className="fixed px-0 py-0 inset-x-0 -top-40 -z-10 transform-gpu overflow-hidden blur-3xl sm:-top-80"
          aria-hidden="true"
        >
          <div
        ...
        <div className="mx-auto max-w-5xl max-h-fit py-5 sm:py-6 lg:py-10">
          ...
          className="mb-6"
        />
            <h1 className="text-4xl text-center font-bold tracking-tight text-indigo-900 sm:text-6xl">
            Somos asesores inmobiliarios y ofrecemos certeza jurídica
            </h1>
    
            <div className="mt-10 mb-20 flex items-center justify-center gap-x-6">
              <Link
                to={"/propiedades"}
